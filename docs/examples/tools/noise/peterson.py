...
f_high, Pxx_dens_high = signal.welch(
    high_noise, fs, nperseg=nperseg, nfft=nfft, scaling="density"
)
f_low, Pxx_dens_low = signal.welch(
    low_noise, fs, nperseg=nperseg, nfft=nfft, scaling="density"
)
