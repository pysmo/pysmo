...
class SacIOBase:
    ...
    iftype: str = field(
        default=SACIO_DEFAULTS.iftype,
        validator=validate_sacenum,
    )
    """Type of file."""

    idep: str = field(
        default=SACIO_DEFAULTS.idep,
        validator=validate_sacenum,
    )
    """Type of dependent variable."""

    iztype: str = field(
        default=SACIO_DEFAULTS.iztype,
        validator=validate_sacenum,
    )
