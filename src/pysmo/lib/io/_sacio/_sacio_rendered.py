...
class ISYNTH(IntEnum):
    rldta = 49


class IMAGTYP(IntEnum):
    mb = 52
    ms = 53
    ml = 54
    mw = 55
...
def _validate_sacenum(
    instance: "SacIOBase", attribute: Attribute[str], value: str
) -> None:
...
def _convert_delta(value: float) -> float:
    return _null_if_undefined(float(value), "delta", optional=False)


def _convert_odelta(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "odelta", optional=True)


def _convert_b(value: float) -> float:
    return _null_if_undefined(float(value), "b", optional=False)


def _convert_o(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "o", optional=True)


def _convert_a(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "a", optional=True)


def _convert_t0(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t0", optional=True)


def _convert_t1(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t1", optional=True)


def _convert_t2(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t2", optional=True)


def _convert_t3(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t3", optional=True)


def _convert_t4(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t4", optional=True)


def _convert_t5(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t5", optional=True)


def _convert_t6(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t6", optional=True)


def _convert_t7(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t7", optional=True)


def _convert_t8(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t8", optional=True)


def _convert_t9(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "t9", optional=True)


def _convert_f(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "f", optional=True)


def _convert_resp0(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp0", optional=True)


def _convert_resp1(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp1", optional=True)


def _convert_resp2(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp2", optional=True)


def _convert_resp3(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp3", optional=True)


def _convert_resp4(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp4", optional=True)


def _convert_resp5(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp5", optional=True)


def _convert_resp6(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp6", optional=True)


def _convert_resp7(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp7", optional=True)


def _convert_resp8(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp8", optional=True)


def _convert_resp9(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "resp9", optional=True)


def _convert_stel(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "stel", optional=True)


def _convert_stdp(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "stdp", optional=True)


def _convert_evel(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "evel", optional=True)


def _convert_evdp(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "evdp", optional=True)


def _convert_mag(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "mag", optional=True)


def _convert_user0(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user0", optional=True)


def _convert_user1(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user1", optional=True)


def _convert_user2(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user2", optional=True)


def _convert_user3(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user3", optional=True)


def _convert_user4(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user4", optional=True)


def _convert_user5(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user5", optional=True)


def _convert_user6(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user6", optional=True)


def _convert_user7(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user7", optional=True)


def _convert_user8(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user8", optional=True)


def _convert_user9(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "user9", optional=True)


def _convert_cmpaz(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "cmpaz", optional=True)


def _convert_cmpinc(value: float | None) -> float | None:
    if value is None:
        return None
    return _null_if_undefined(float(value), "cmpinc", optional=True)


def _convert_nzyear(value: int | None) -> int | None:
    return _null_if_undefined(value, "nzyear", optional=True)


def _convert_nzjday(value: int | None) -> int | None:
    return _null_if_undefined(value, "nzjday", optional=True)


def _convert_nzhour(value: int | None) -> int | None:
    return _null_if_undefined(value, "nzhour", optional=True)


def _convert_nzmin(value: int | None) -> int | None:
    return _null_if_undefined(value, "nzmin", optional=True)


def _convert_nzsec(value: int | None) -> int | None:
    return _null_if_undefined(value, "nzsec", optional=True)


def _convert_nzmsec(value: int | None) -> int | None:
    return _null_if_undefined(value, "nzmsec", optional=True)


def _convert_nvhdr(value: int) -> int:
    return _null_if_undefined(value, "nvhdr", optional=False)


def _convert_norid(value: int | None) -> int | None:
    return _null_if_undefined(value, "norid", optional=True)


def _convert_nevid(value: int | None) -> int | None:
    return _null_if_undefined(value, "nevid", optional=True)


def _convert_nsnpts(value: int | None) -> int | None:
    return _null_if_undefined(value, "nsnpts", optional=True)


def _convert_nwfid(value: int | None) -> int | None:
    return _null_if_undefined(value, "nwfid", optional=True)


def _convert_iinst(value: str | None) -> str | None:
    return _null_if_undefined(value, "iinst", optional=True)


def _convert_istreg(value: str | None) -> str | None:
    return _null_if_undefined(value, "istreg", optional=True)


def _convert_ievreg(value: str | None) -> str | None:
    return _null_if_undefined(value, "ievreg", optional=True)


def _convert_kstnm(value: str | None) -> str | None:
    return _null_if_undefined(value, "kstnm", optional=True)


def _convert_kevnm(value: str | None) -> str | None:
    return _null_if_undefined(value, "kevnm", optional=True)


def _convert_khole(value: str | None) -> str | None:
    return _null_if_undefined(value, "khole", optional=True)


def _convert_ko(value: str | None) -> str | None:
    return _null_if_undefined(value, "ko", optional=True)


def _convert_ka(value: str | None) -> str | None:
    return _null_if_undefined(value, "ka", optional=True)


def _convert_kt0(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt0", optional=True)


def _convert_kt1(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt1", optional=True)


def _convert_kt2(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt2", optional=True)


def _convert_kt3(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt3", optional=True)


def _convert_kt4(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt4", optional=True)


def _convert_kt5(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt5", optional=True)


def _convert_kt6(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt6", optional=True)


def _convert_kt7(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt7", optional=True)


def _convert_kt8(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt8", optional=True)


def _convert_kt9(value: str | None) -> str | None:
    return _null_if_undefined(value, "kt9", optional=True)


def _convert_kf(value: str | None) -> str | None:
    return _null_if_undefined(value, "kf", optional=True)


def _convert_kuser0(value: str | None) -> str | None:
    return _null_if_undefined(value, "kuser0", optional=True)


def _convert_kuser1(value: str | None) -> str | None:
    return _null_if_undefined(value, "kuser1", optional=True)


def _convert_kuser2(value: str | None) -> str | None:
    return _null_if_undefined(value, "kuser2", optional=True)


def _convert_kcmpnm(value: str | None) -> str | None:
    return _null_if_undefined(value, "kcmpnm", optional=True)


def _convert_knetwk(value: str | None) -> str | None:
    return _null_if_undefined(value, "knetwk", optional=True)


def _convert_kdatrd(value: str | None) -> str | None:
    return _null_if_undefined(value, "kdatrd", optional=True)


def _convert_kinst(value: str | None) -> str | None:
    return _null_if_undefined(value, "kinst", optional=True)
